...
- rastrear um produto
- definir limite mínimo de um produto no estoque
- emitir alerta quando o estoque de um produto estiver chegando próximo ao fim
...
- visualizar as tendências de estoque ao longo do tempo
